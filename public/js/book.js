  ...
  methods: {
    ...
    fetchServices: function fetchServices() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/services").then(function (response) {
        _this6.services = response.data; // Cập nhật biến services với dữ liệu lấy từ server
      })["catch"](function (error) {
    ...
    fetchArtistlevels: function fetchArtistlevels() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/artist-levels").then(function (response) {
        _this7.artistlevels = response.data; // Cập nhật biến services với dữ liệu lấy từ server
      })["catch"](function (error) {
    ...
    calculateTotalSelectedServicesPrice: function calculateTotalSelectedServicesPrice() {
      ...
      var serviceTotalPrice = this.selectedServices.reduce(function (totalPrice, serviceId) {
        var servicePrice = _this8.getServicePrice(serviceId);
        var serviceSalePrice = _this8.getServiceSalePrice(serviceId);
        totalPrice += parseFloat(servicePrice) - parseFloat(serviceSalePrice);
        return totalPrice;
      }, 0);
...
var render = function render() {
  ...
  }, [_vm._v("Next")])] : _vm._e(), _vm._v(" "), _vm.step === "artistlevels" ? [_c("ul", _vm._l(_vm.artistlevels, function (artistLevel) {
    return _c("li", {
      key: artistLevel.id
    }, [_c("label", [_c("input", {
      directives: [{
  ...
  }, [_vm._v("Submit")])] : _vm._e(), _vm._v(" "), [_c("div", [_vm.step === "groupService" ? [_vm._l(_vm.groupServices, function (groupService) {
    return _c("div", {
