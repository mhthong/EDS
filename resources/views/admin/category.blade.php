                ...
                <div class="main__body">
                    ...
                    <div class="main__body__data">
                                    ...
                                    <nav id="active-form" class="tabs-left">
                                        <ul class=" flexb-col-c nav tabs menu_level" id="menu_tabs"
                                            ...
                                            <li class="tab tab-link menu_level_1 menu_add add" data-tab="add">
                                                <button class="btn btn-primary menu_add_btn">Add new</button>
                                            </li>
                                                    ...
                                                    @foreach ($data['Menus_parent'] as $Menus => $Menu)
                                                        @foreach ($Menu as $Menus_name)
                                                            <li class="">
                                                                ...
                                                                <div class="menu_category tab-link">
                                                                    <span class="tab"
                                                                    data-tab="{{ $Menus_name->id }}">{{ $Menus_name->name }}</span>
                                                                ...
                                                                @if (isset($data['parent_id'][$Menus_name->id]) && $data['parent_id'][$Menus_name->id] !== "")
                                                                    @php
                                                                        function buildSubMenu($menuData, $parentId, $level = 2)
                                                                        {
                                                                            if (isset($menuData['parent_id'][$parentId]) ) {

                                                                                echo '<ul class="menu_level_' . $level . '_ul">'; // Determine submenu level
                                                                                foreach ($menuData['parent_id'][$parentId] as $mp_value) {
                                                                                    echo '<li class="tab-link menu_level_' . $level . '"><span class="tab" data-tab="' . $mp_value . '">' . $menuData['Menu_child_name'][$mp_value] . '</span><form class="distroy" method="POST" action="' . route('category.delete', ['id' => $mp_value]) . '" onsubmit="return ConfirmDelete(this)"><input type="hidden" name="_method" value="DELETE">' . csrf_field() . '<button class="delect__category" type="submit">Xóa</button></form>';
                                                                        
                                                                                    // Kiểm tra và gọi đệ quy xây dựng submenu cấp 3 hoặc cao hơn
                                                                        
                                                                                    $MenuNode_parent1 = App\Models\MenuNode::select('*')
                                                                                        ->where('parent_id', $mp_value)
                                                                                        ->get();
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 col-xxl-9 flexb-c">
                            <div class=" bg-ad-1 flexb-col-c">
                                <div class="col-12 bg-ad">
                                    <form method="POST" action="{{ route('category-up') }}"
                                        class="mt-8 space-y-6 col-12 current" accept-charset="UTF-8" id="add">
                                        ...
                                        <div class="form-group">
                                            ...
                                            aria-required="true">Father</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Sort" name="order" type="number"
                                                value="0" id="order">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="-space-y-px mb-4">
                                                <div class="containerInput input-group">
                                                    ...
                                                    <p class="p p-1 col-12 bg-span">1920*700 px - Custom height.</p>
               ...
               {{--                          <div id="advanced-sortables" class="form-control pt-3 mt-3 meta-box-sortables">
                                            <div id="seo_wrap" class="widget meta-boxes">
                                                ...
                                                <div class="widget-body">
                                                    <a href="#" class="btn-trigger-show-seo-detail">Chỉnh sửa
                                                        SEO</a>
                                                    <div class="seo-preview">
                                                        <p class="default-seo-description ">Thiết lập các thẻ mô tả giúp
                                                            người dùng dễ
                                                            dàng
                                                    ...
                                                    <div class="seo-edit-section hidden">
                                                        <hr>
                                                        <div class="form-group">
                                                            <label for="seo_title" class="control-label">Tiêu đề
                                                                trang</label>
                                    ...
                                    @isset($data)
                                        @isset($data['Menus_parent'])
                                            @foreach ($data['Menus'] as $Menus_rows)
                                                ...
                                                <form class="mt-8 space-y-6 col-12 content-none"
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="control-label required"
                                                            aria-required="true">Name</label>
                                                        <input class="form-control valueInp" placeholder="Nhập tên"
                                                            data-counter="120" name="name" type="text"
                                                            value="{{ $Menus_rows->name }}" id="valueInput">
                                                    </div>
                                                        ...
                                                        @foreach ($data['MenuNodes'][$Menus_rows->id] as $MenuNode)
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="ui-select-wrapper form-group">
                                                                    ...
                                                                    <select
                                                                        class="select-search-full ui-select ui-select select2-hidden-accessible"
                                                                        id="parent_id" name="parent_id" tabindex="-1"
                                                                        aria-hidden="true">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="description" class="control-label">Description</label>
                                                                <textarea class="form-control" rows="4" placeholder="Description" data-counter="400" name="description"
                                                                    cols="50" id="description">@if (isset($MenuNode->title) && $MenuNode->title != null){{ $MenuNode->title }}@endif</textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="icon" class="control-label">Icon</label>
                                                                <input class="form-control" placeholder="Ex: fa fa-home"
                                                                    data-counter="60" name="icon" type="text" id="icon"
                                                                    ...
                                                                    @endisset">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" placeholder="Sắp xếp" name="order"
                                                                                ...
                                                                                value="@isset($MenuNode->position){{ $MenuNode->position }}
                                                                    @endisset">
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="onoffswitch switch">
                                                                    @isset($MenuNode->target)
                                                                        @if ($MenuNode->target == 1)
                                                                            <label for="is_featured" class="control-label">Floating
                                                                                turn on?</label>

                                                                            <label class="switch">
                                                                                <input type="hidden" name="is_featured" value="0">
                                                                                <input type="checkbox" name="is_featured"
                                                                                    class="onoffswitch-checkbox" id="is_featured"
                                                                                    value="1" checked>
                                                                                <span class="slider"></span>
                                                                            </label>
                                                                        @else
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                @isset($MenuNode->css_class)
                                                                    <img src="{{ asset($MenuNode->css_class) }} " alt="image"
                                                                        sizes="" style="width: 200px;" srcset="">
                                                                    <div class="-space-y-px mb-4">
                                                                        <div class="containerInput input-group">
                                                                            <span class="input-group-btn">
                                                                            ...
                                                                            <p class="p p-1 col-12 bg-span">1920*700 px - Custom height
                                                                                edit.</p>
                                                                            <input class="form-control"
                                                                                id="data-input{{ $MenuNode->menu_id }}"
                                                                                style="display: none" type="text" name="image">
                                                                            <p class="p-2 col-12">Updated image</p>
                                                                            <div class="holder image-category"
                                                                                id="data-image{{ $MenuNode->menu_id }}" value="image">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endisset
                                         ...
                                         {{--            <div id="advanced-sortables"
                                                        class="form-control pt-3 mt-3 meta-box-sortables">
                                                        <div id="seo_wrap" class="widget meta-boxes">
                                                            <div class="widget-title">
                                                                <h4><span>Tối ưu hoá bộ máy tìm kiếm (SEO)</span></h4>
                                                            </div>
                                                            ...
                                                            @isset($MetaBoxes[$Menus_rows->id])
                                                                @foreach ($MetaBoxes[$Menus_rows->id] as $MetaBoxe)
                                                                    <div class="widget-body">
                                                                        <a href="#" class="btn-trigger-show-seo-detail">Chỉnh
                                                                            sửa SEO</a>
                                                                        <div class="seo-preview">
                                                                            <p class="default-seo-description ">Thiết lập các thẻ mô tả
                                                                                giúp người
                                                                                dùng
                                                                                dễ
                                                                                dàng
                                                                            ...
                                                                            <div class="existed-seo-meta  hidden ">
                                                                                ...
                                                                                <div class="ws-nm">
                                                                                    <span style="color: #70757a;">Feb 20, 2023 -
                                                                                    </span>
                                                                                    <span class="page-description-seo">
                                                                        ...
                                                                        @isset($MetaBoxe->meta_value)
                                                                            <div class="seo-edit-section hidden">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="seo_description" class="control-label">Mô
                                                                                        tả
                                                                                        trang</label>
                                                                                    <textarea class="form-control" rows="3" id="seo_description" placeholder="Mô tả trang" data-counter="160"
