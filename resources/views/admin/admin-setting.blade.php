                                    ...
                                    <div class="thumb">
                                        <div class="profile-userpic mt-card-item">
                                            <div class="avatar-view mt-card-avatar mt-overlay-1">
                                                @if ($user->avatar != '')
                                                    <img src="{{ asset($user->avatar) }}" class="img-fluid img"
                                                        alt="avatar">
                                                @else
                                                    <img src="{{ asset('./storage/photos/1/Image/user-286.png') }}"
                                                        class="img-fluid img" alt="avatar">
                                                @endif
                            ...
                            <div class="bg-ad flexb-col-c">
                                ...
                                <div class="containerInput -space-y-px mb-4" style="position: relative;">
                                    <div class="input__user">
                                        ...
                                        <input id="password-renew" minlength="8" name="passwordrenew" type="password"
                                            required
                                            class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
        ...
        @if (Auth::user() instanceof \App\Models\Artists)
            ...
            <script>
                ...
                $('#avatarForm').submit(function(event) {
                    ...
                    $.ajax({
                        url: "{{ route('artists.updateAvatar') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
