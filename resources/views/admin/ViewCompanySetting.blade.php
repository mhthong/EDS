...
<div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 col-xxl-9 flexb-c nav_content">
    <div class="bg-ad-1 flexb-col-c">
        ...
        <div class="col-12 bg-ad ">
            <form class="mt-8 space-y-6 col-12 tab-content" action="{{ route('setting-up') }}" method="POST" id="a">
                @csrf
                    ...
                    <div class="containerInput ">
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="5"class="form-control" id="Google-map-embed" name="Google-map-embed"
                                type="text" required
                                class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                placeholder="Chèn iframe - google map" value="">@isset($array['Google-map-embed']){{ $array['Google-map-embed'] }}@endisset</textarea>
        ...
        <div class="col-12 bg-ad ">
            <form class="mt-8 space-y-6 col-12 tab-content " action="{{ route('setting-up') }}" method="POST" id="b">
                @csrf
                <div class="-space-y-px mb-4">
                    <div class="containerInput">
                        <div class="form-group ">
        ...
        <div class="col-12 bg-ad ">
            <form class="mt-8 space-y-6 col-12 tab-content " action="{{ route('setting-up') }}" method="POST" id="c">
                @csrf
                <div class="-space-y-px mb-4">
                    <div class="containerInput ">
                        <div class="form-group">
        ...
        <div class="col-12 bg-ad ">
            <form class="mt-8 space-y-6 col-12 tab-content  " action="{{ route('setting-up') }}" method="POST" id="d">
                @csrf
                <div class="-space-y-px mb-4">
                    <div class="containerInput ">
                        <div class="form-group">
        ...
        <div class="col-12 bg-ad ">
            <form class="mt-8 space-y-6 col-12 tab-content" action="{{ route('setting-up') }}" method="POST" id="e">
                @csrf
                <div class="-space-y-px mb-4">
                    <div class="containerInput ">
                        <div class="form-group ">
