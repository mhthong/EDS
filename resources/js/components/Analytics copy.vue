<template>
  ...
  <div class="radio-section">
    ...
    <button class="btn" :class="{ 'active': selectedOptions.includes('Service Booking') }" @click="toggleOption('Service Booking')">Service Booking</button>
    <button class="btn" :class="{ 'active': selectedOptions.includes('Channel Source') }" @click="toggleOption('Channel Source')">Channel Source</button>
...
export default {
  ...
  methods: {
    ...
    handleSelectedOptions() {
      ...
      if (this.selectedOptions.includes('Revenue')) {
        this.renderChartRevenue();
      }
      if (this.selectedOptions.includes('Service Booking')) {
        this.renderChartService();
      }
      if (this.selectedOptions.includes('Channel Source')) {
