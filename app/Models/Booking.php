...
class Booking extends Model
{
    ...
    protected static $logAttributes = ['ArtistID', 'ShowroomID', 'time','time_end', 'date', 'GetID','price_id', 'content','action','status','source_name','source_id','source_type','source_data','Source' , 'Note','After_img','Before_img','change_time_servies','cancel_wage','change_service_wage','OT_wage' ,'created_at'];


    // Define the table associated with the model
    protected $table = 'bookings';

    protected $fillable = ['ArtistID', 'ShowroomID', 'time','time_end', 'date', 'GetID','price_id', 'content','action','status','source_name','source_id','source_type','source_data','Source' , 'Note','After_img','Before_img' ,'change_time_servies','cancel_wage','change_service_wage','OT_wage','created_at'];
